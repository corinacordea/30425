...
public class Game {
	...
	private static Scanner scanner = new Scanner(System.in); // DONE TODO: Initialize the value of scanner so that you can
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// DONE TODO: Print rules by calling method on FileReader utility class
		...
		// DONE TODO: Read miner name and place it into a variable.. Look around for the variable name
		String minerName = scanner.next();
		
		System.out.println("[Game] Miner '" + minerName + "' is getting ready to mine!");
		Thread.sleep(500);
		
		// DONE TODO: Create a new miner with the name you have just read
		Miner miner = new Miner(minerName);
		
		System.out.println("[Game] Miner '" + minerName + "': Show me where to dig!");
		Thread.sleep(1000);
		
		// DONE TODO: Create a new map and generate the resources
		Map map = new Map();
		...
		for (int i = 0; i < Constants.NUMBER_OF_ROUNDS; i++) {
			...
			// DONE TODO: Display the resources from the map
			map.showResources();
			...
			// DONE TODO: Read an integer from the keyboard and update 
			...
			switch (minerNextAction) {
				case 0:
					...
					// DONE TODO: Make the miner sleep and update the resource variable with the
				...
				case 1:
					...
					// ??? DONE TODO: Make the miner dig and update the resource variable with the
					// 	     value returned by the sleep method ????????? dig method ??????
					resource = miner.dig();
